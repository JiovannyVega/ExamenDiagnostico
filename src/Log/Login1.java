...
public class Login1 extends javax.swing.JFrame {
    ...
    public Login1() {
        try {
            ...
            con = DriverManager.getConnection("jdbc:mysql://localhost:3306/Quimica", Usuario, Password);
        } catch (Exception e) {
        ...
        initComponents();
        this.setTitle("Login");
        //Image img = Toolkit.getDefaultToolkit().getImage(getClass().getResource("/src/Imagenes/icono.png"));
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Inventario Laboratorio de Quimica");
